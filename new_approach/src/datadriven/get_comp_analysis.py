...
# Configuration
INPUT_FILE = "/Users/manikeshmakam/Endgame 2.0/ethicalAI/data/datadriven/inputs/datadriven_competitions_final.json"
OUTPUT_FILE = "/Users/manikeshmakam/Endgame 2.0/ethicalAI/data/datadriven/results/ethical_analysis.json"
...
# System Prompt (same as Kaggle analysis)
SYSTEM_PROMPT = """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Analyze DataDriven competitions using Gemini API.")
    parser.add_argument(
        "--start_index",
        type=int,
        default=0,
